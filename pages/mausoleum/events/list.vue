<template>
    <div class="back-navbar container flex items-center justify-between">
        <span><span @click.="$router.push('/')" class="material-symbols-outlined back-icon ml-2">
                trending_flat </span><span class="back-title">رویداد‌ها</span></span>
    ...
    <div class="container">
        ...
        <div v-else>
            <div class="search-container centered w-full">
                ...
                <img @click.stop="showSelectDate = true" class="calendar" src="@/assets/images/icons/calendar.svg" alt="">
                <input @click="$router.push('./search')" class="custom-input" placeholder="جستجو" type="text">
            </div>
            <div class="swipper-container">
                <div class="event-list w-full mt-10">
                    <p>امروز</p>
                    <Swiper class="mt-3" :modules="[SwiperAutoplay, SwiperEffectCreative]" :slidesPerView="'auto'"
                        :spaceBetween="8" :loop="false" :autoplay="{
                            delay: 8000,
        ...
        <div class="add-container ">
            ...
            @click="$router.push('./create')"
                class="bg-primary text-white mt-3 flex justify-center items-center gap-2 py-2 px-4  h-11 rounded-lg">
                <img src="@/assets/images/icons/add-square.svg">
            </button>
        </div>
    </div>
