<template>
  <div class="back-navbar container flex items-center justify-between">
    <span
      ...
      >
        trending_flat </span
      ><span class="back-title">افزودن رویداد جدید</span></span
    >
  </div>
  <div class="container">
    ...
    <div class="mt-6">
      <div>
        ...
        <div style="position: relative">
          <svg
            style="position: absolute; left: 12px; top: 22px"
  ...
  <BottomSheets
    :title="'تاریخ مورد نظر را انتخاب کنید.'"
