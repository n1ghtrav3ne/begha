<template>
  <div class="gravePage">
    ...
    <div class="container">
      <div class="formContainer">
        <div class="w-full" v-for="(item, index) in inputItems" :key="index">
          <inputOnes
            class="theInputs"
            :class="{ active: uploadCheck && index === 4 }"
            @click="showInputValues(index)"
            :id="index"
            :item="item"
          />
        </div>
      ...
      <div class="terms">
        ...
        <span @click="termsSheet = true" class="txt"
          >را مطالعه کرده و آن را می پذیرم.</span
        >
      </div>
    ...
    <BottomSheets title="مطالعه قوانین و مقررات" v-model="termsSheet">
      <terms />
    </BottomSheets>

    <BottomSheets
      title="تاریخ فوت متوفی را انتخاب کنید."
      v-model="dateOfDeathSheet"
    >
      <dateOfDeath />
    </BottomSheets>

    <BottomSheets title="نسبت شما با متوفی" v-model="personalRatioSheet">
      <personalRatio />
    </BottomSheets>

    <BottomSheets
      title="قطعه مورد نظر خود را انتخاب کنید."
      v-model="graveSectionSheet"
    >
      <graveSection />
    </BottomSheets>
