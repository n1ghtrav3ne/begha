<template>
  <div class="sectionContainer">
    <div
      ...
      :class="{ active: index === activeItem && !section.capacity }"
    ...
    >
      <img
        ...
        src="~/assets/images/cemetery/grave-stone copy 2.svg"
        alt=""
      />
      ...
      <img
        class="mr-auto hidden"
        src="~/assets/images/cemetery/tick-circle.svg"
        alt=""
      />
    </div>
  </div>
