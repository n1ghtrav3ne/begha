...
<div class="container">
    ...
    <img
      ...
      class="mr-auto"
      src="~/assets/images/cemetery/search-normal copy.svg"
      alt=""
    />
  </div>
    ...
    <div class="cemeteryTitle">
      ...
      <div @click="graveReservationOpen = true" class="graveReq">
        <div class="imgHolder">
          <img
            class="graveImg"
            src="~/assets/images/cemetery/grave-stone.svg"
            alt=""
          />

          <img
            class="addImg"
            src="~/assets/images/cemetery/add-circle.svg"
            alt=""
          />
        </div>
  ...
  <BottomSheets title="مرتب سازی بر اساس" v-model="orderingFilterSheet">
    <orderingFilter />
  </BottomSheets>
  ...
  <graveReserve
    @close="graveReservationOpen = false"
    v-if="graveReservationOpen"
  />
</template>
...
const theDeceaseds = ref<
  { name: string; fatherName: string; section: string }[]
>([
  {
    name: "محمدرضا موسوی",
