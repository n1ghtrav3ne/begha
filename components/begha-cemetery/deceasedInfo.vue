  ...
  <div class="infoContainer">
    ...
    <div class="date">
      <div class="birthDate">
        ...
        <span>۱۳۰۲/۱۲/۱۲</span>
      </div>

      <div class="deathDate">
        <span>تاریخ فوت</span>

        <span>۱۳۷۸/۱۲/۱۲</span>
      </div>

      <div class="burialPlace">
        <span>محل دفن</span>

        <span>قطعه شهدا، قبر ۲۱۲، طبقه ۲</span>
      </div>
    </div>

    <div class="diary">
      <span class="title"> زندگی‌نامه </span>
...
.infoContainer {
  ...
  .date {
    ...
    width: 100%;
    height: auto;
    border-top: 1px solid $secondary-s;
