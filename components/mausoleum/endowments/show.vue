<template>
  <div>
    ...
    <div class="p-4">
      <!-- banner -->
      <div>
        <img :src="endowment?.image" class="aspect-video" />
      </div>
      ...
      <div>
        <div class="flex justify-between">
          <h1 class="text-base">{{ endowment?.title }}</h1>
          <img
            src="/assets/images/icons/dots.svg"
            class="mr-3 cursor-pointer"
          />
        </div>
        <p class="mt-3 text-justify text-sm">{{ endowment?.description }}</p>
      </div>
...
const endowment = ref({
  image: "/carpet2.png",
  title: "فرش ۱۲ متری (۴ تخته) ",
  description:
    "برگزاری مراسم ترحیم در بقعه متبرکه از دیرباز جزیی از این اجرای مراسم ترحیم میباشد.رزرو بقعه متبرکه مراسم ترحیم پس از خاکسپاری و تهیه اقلام پذیرایی.",
  user: {
    name: "سید علی هاشمی",
    date: "۲۲ اردیبهشت ۱۳۰۹",
    code: "۳۷۴۸۲۰۲",
    file: "",
  },
});
