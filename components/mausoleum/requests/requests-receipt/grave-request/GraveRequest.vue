    ...
    <div class="greenBox flex flex-row pt-[12px] pb-[11px] px-[16px] bg-primary-700 w-full items-center">
       ...
       <div class="container">
           ...
           <div class="flex flex-col gap-1">
               ...
               <span class="text-[16px] font-bold">قبر</span>
           ...
           <span v-if="failed" class="text-xs font-normal bg-error-100 rounded-lg text-error-700 px-3 py-2">لغو شده توسط کاربر</span>
               ...
               <hr class="my-2 w-full text-neutral-100">

               <span class="text-xs font-normal text-neutral-500">شما می‌توانید با تائيد درخواست، موقعیت دقیق را مشخص و سپس تائيد را ثبت کنید.</span>
               ...
               <div v-if="confirmed" class="flex flex-col py-2 px-4 gap-2 border text-primary-700 border-success-400 bg-primary-200 rounded-xl mt-8">
                   ...
                   <span class="text-xs font-normal">درخواست کاربر در تاریخ ۱۴۰۲/۱۲/۱۲ ساعت ۱۲:۳۴  (با موقعیت قطعه شهدا، شماره ۱۲، طبقه ۱) تائید شد. </span>
               ...
               <div class="mt-8 rounded-xl w-full flex flex-col px-3 py-3 bg-white ">
                        ...
                        <div  v-for="(item , index) in receiptInfo" :key="index">
                            ...
                            <div class="flex flex-row items-center py-3 border-b border-dashed border-neutral-100 w-full justify-between">
                        ...
                        <div v-if="index===5" class="flex flex-row items-center py-3 border-b border-dashed border-neutral-100 w-full justify-between">
                            
                            <span class="text-xs font-normal text-neutral-500">گواهی فوت</span>

                            <span class="font-bold text-sm text-secondary-700">مشاهده فایل</span>
       ...
       <BottomSheets v-model="RejectMessageSheet">
           ...
           <RejectMessage @close="RejectMessageSheet=false" />
...
import GravePosition from './GravePosition.vue';
...
>([
   ...
   {
       title:'قبر درخواستی',
       value:'قطعه شهدا، شماره ۱۲، طبقه ۳',
   },
   {
    title:'مبلغ پرداختی',
