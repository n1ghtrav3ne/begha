  ...
  <div class="w-full flex flex-col delete-container">
    ...
    <div class="flex justify-between mb-4">
      <button
        type="button"
        :class="`bg-${color}`"
        class="me-2 w-1/2 inline-block rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-700-accent-300 hover:shadow-primary-2 focus:bg-primary-700-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-700-600 active:shadow-primary-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong mr-2"
      >
        بله
      </button>
      <button
