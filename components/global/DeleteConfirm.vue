<template>
    <div class="w-full flex flex-col delete-container">
      <div class="flex flex-col justify-center items-center trash-cn mt-3">
        <img class="w-8 h-8 flex-shrink-0" src="@/assets/images/icons/trash.svg" />
        <span class="mt-3 mb-10">آیا از حذف این مورد از لیست رزرو اطمینان دارید؟</span>
      </div>
      <div class="flex justify-between mb-4">
        <button
    type="button"
    class="me-2 w-1/2 inline-block rounded bg-error px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong mr-2">
    بله
  </button>
        <button
          type="button"
